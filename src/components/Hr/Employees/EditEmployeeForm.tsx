      ...
      contactDetails:
        ...
        values.country
          ? {
              ...
              country:
                GetCountries().find((c: any) => c.isoCode === values.countryCode)
                  ?.name || "",
              region:
                GetState(values.countryCode).find(
                  (s: any) => s.isoCode === values.stateCode
                )?.name || "",
              city: values.city,
            }
          ...
          {(formikProps) => (
            <>
                    ...
                    {({ field, form, meta }: FieldProps) => (
                      <div className="relative">
                        ...
                        >
                          ...
                          <SelectContent position="popper" className="z-[2010]">
                            <SelectGroup>
                    ...
                    {({ field, form, meta }: FieldProps) => (
                      <div className="relative">
                        <Select
                          ...
                          defaultValue={field.value}
                        >
                          <SelectTrigger id="workType" className="w-full py-6">
                    ...
                    {({ field, form, meta }: FieldProps) => (
                      <div className="relative">
                        <Select
                          ...
                          defaultValue={field.value}
                        >
                          <SelectTrigger id="leaveType" className="w-full py-6">
                      ...
                      <div className="relative">
                        <Select
                          onValueChange={(value) => {
                            ...
                            form.setFieldValue("region", state?.name || "");
                            form.setFieldValue("city", "");
                          }}
                          value={field.value}
                        ...
                        >
                          ...
                          <SelectContent position="popper" className="z-[2010]">
                            <SelectGroup>
                              ...
                              {GetStates(form.values.countryCode).map(
                                (state) => (
                                  <SelectItem
                                    key={state.isoCode}
                                    value={state.isoCode}
                    ...
                    {({ field, form, meta }: FieldProps) => (
                      <div className="relative">
                        <Select
                          ...
                          value={field.value}
                          disabled={!form.values.stateCode}
                        >
              ...
              <div className="flex w-full gap-3 mt-8 h-14">
                <button
                  type="button"
                  onClick={() => !updateEmployeeMutation.isPending && onClose()}
