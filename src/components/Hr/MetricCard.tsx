...
export const MetricCard = ({ title, value, growth, color }: IMetricCard) => {
  ...
  const ChartLine = ({ color }: {color: string}) => (
    ...
    // <svg className="h-8 w-20" viewBox="0 0 100 30">
    //   <path
    //     d="M0 20 L10 15 L20 25 L30 10 L40 15 L50 5 L60 20 L70 10 L80 15 L90 5 L100 10"
    //     fill="none"
    //     stroke={color}
    //     strokeWidth="3"
    //     strokeLinecap="round"
