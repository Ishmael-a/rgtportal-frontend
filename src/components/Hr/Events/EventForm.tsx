...
const EventForm = memo(({ formik, selectedFormType, selectedSpecialEventType, setSelectedSpecialEventType, selectedEmployee, setSelectedEmployee, users, projects }: IEventForm) => {
  ...
  const handleProjectPopoverOpenChange = useCallback((index: number, open: boolean) => {
  ...
  const renderEventTypeFields = useCallback((selectedSpecialEventType: string) => {
  ...
  const renderFormFields = useCallback((formType: string) => {
                ...
                <div className="space-y-4">
                  <div className="flex flex-col gap-4 ">
                    ...
                    <div className="w-full text-left flex">
                      <p className="w-1/2  text-sm font-medium">Employee Name</p>
  ...
  }, [handlePopoverOpenChange, handleProjectPopoverOpenChange, popoverOpenStates, projectPopoverOpenStates, selectedSpecialEventType, setSelectedEmployee, setSelectedSpecialEventType, users, projects]);
