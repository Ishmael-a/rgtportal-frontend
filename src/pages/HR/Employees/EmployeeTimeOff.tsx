...
import {timeOffManagementData, timeOffData} from "@/constants"
    ...
    return (
        ...
        <div className="flex flex-col gap-[15px] pt-[10px] h-full ">
            <section className="h-[62px] flex justify-between w-full items-center py-1">
                ...
                {/* Title */}
                <h1 className="text-2xl font-medium text-gray-600">Employee TimeOff Requests</h1>
            ...
            <div className="flex flex-col  h-full  ">
                <EmployeeTimeOffManagementTable initialData={timeOffManagementData}/>
            </div>
        </div>
    </>
